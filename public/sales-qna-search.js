...
class SalesQnASearch {
  ...
  showLoading = show => {
    ...
    if (show) {
      ...
      askQuestion.innerHTML = '<span><i class="fa fa-spinner"></i> Analyzing...</span>';
    } else {
      loadingState.classList.remove('show');
      askQuestion.disabled = false;
      askQuestion.innerHTML = '<span><i class="fa fa-search"></i> Find Matches</span>';
    }
  };
                    ...
                    <div class="match-item ${scoreClass}" style="animation-delay: ${index * 0.1}s">
                                  ...
                                  match.similar_questions && match.similar_questions.length
                                    ...
                                    <div class="similar-questions">
                                        <div class="match-question">Similar Questions</div>
                                            ${match.similar_questions
                                              .map(
                                                q => `
                                                   <div class="match-question similar"> - "${
                                                     q.question
                                                   }" <span class="similar-score">(${Math.round(
                                                  q.similarity * 100
                                                )}%)</span></div>
                                            `
                                              )
                        ...
                        <div class="match-content">
                            ...
                            <button id="copy-btn" class="copy-btn" data-answer="${match.answer.replace(/'/g, "\\'")}">
                                <i class="fa fa-copy"></i> Copy Answer
                            </button>
                        </div>
                    </div>
                `;
